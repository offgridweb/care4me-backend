...
class UsersController extends Controller
{
	...
	public function checkversion(){
		$version = SystemSettings::select('user_version','admin_version')->first();
		return $version;
	}
	...
	public function register(Request $request){
		...
		$provider->provider_display_name = $data['company'];
		$provider->provider_organization_name = $data['company'];
		$provider->provider_add1 = $data['building'];
		$provider->provider_add2 = $data['address1'];
		$provider->provider_add3 = $data['address2'];
		$provider->provider_postcode = $data['postcode'];
		$provider->provider_website = $data['website'];
		$provider->provider_email = $data['contactemail'];
	 ...
	 public function checkuserexists(Request $request)
    {
		...
		if($user == null){$message = false;} else $message = true;
			
		return array('error'=>false,'message'=>$message,'code'=>200);
    }
